...
(function(b) {
	function t() {
		...
		a.height || !(e = l.compatMode) && b.support.boxModel || (e = "CSS1Compat" === e ? f : l.body, a = {
	...
	a.fn.prettyEmbed = function(c) {
		...
		f = 0 === a(this).length ? a(".pretty-embed") : a(this), f.each(function() {
			...
			if (f = a(this).attr("data-pe-videoid") !== b ? a(this).attr("data-pe-videoid") : a(this).attr("href") !== b ? h(a(this).attr("href")) : c.videoID, g = a(this).attr("data-pe-preview-size") !== b ? a(this).attr("data-pe-preview-size") : c.previewSize !== b ? c.previewSize : b, i = a(this).attr("data-pe-custom-preview-image") !== b ? a(this).attr("data-pe-custom-preview-image") : c.customPreviewImage !== b ? c.customPreviewImage : b, j = a(this).attr("data-pe-show-info") !== b ? a(this).attr("data-pe-show-info") : c.showInfo !== b ? c.showInfo : b, k = a(this).attr("data-pe-show-controls") !== b ? a(this).attr("data-pe-show-controls") : c.showControls !== b ? c.showControls : b, l = a(this).attr("data-pe-loop") !== b ? a(this).attr("data-pe-loop") : c.loop !== b ? c.loop : b, m = a(this).attr("data-pe-closed-captions") !== b ? a(this).attr("data-pe-closed-captions") : c.closedCaptions !== b ? c.closedCaptions : b, n = a(this).attr("data-pe-localization") !== b ? a(this).attr("data-pe-localization") : c.localization !== b ? c.localization : b, o = a(this).attr("data-pe-color-scheme") !== b ? a(this).attr("data-pe-color-scheme") : c.colorScheme !== b ? c.colorScheme : b, p = a(this).attr("data-pe-show-related") !== b ? a(this).attr("data-pe-show-related") : c.showRelated !== b ? c.showRelated : b, q = a(this).attr("data-pe-allow-fullscreen") !== b ? a(this).attr("data-pe-allow-fullscreen") : c.allowFullScreen !== b ? c.allowFullScreen : b, a(this).is("a") && (e = a("<div />").addClass("pretty-embed"), e.attr("data-pe-videoid", f).attr("data-pe-preview-size", g).attr("data-pe-custom-preview-image", i).attr("data-pe-show-info", j).attr("data-pe-show-controls", k).attr("data-pe-loop", l).attr("data-pe-closed-captions", m).attr("data-pe-localization", n).attr("data-pe-color-scheme", o).attr("data-pe-show-related", p).attr("data-pe-allow-fullscreen", q), a(this).after(e)), i !== b && "" !== i) a(this).html('<img src="' + i + '" width="100%" alt="YouTube Video Preview" />');
				...
				a(this).html('<img src="//img.youtube.com/vi/' + f + "/" + s + '.jpg" width="100%" alt="YouTube Video Preview" />')
			}
...
+
	function(a) {
		...
		var f = "touch-carousel",
			g = function(b, c) {
				return this.$element = a(b), this.$itemsWrapper = this.$element.find(".carousel-inner"), this.$items = this.$element.find(".item"), this.$indicators = this.$element.find(".carousel-indicators"), this.pane_width = this.pane_count = this.current_pane = 0, this.onGesture = !1, this.options = c, this._setPaneDimensions(), this.$items.length <= 1 ? this.disable() : (this._regTouchGestures(), void a(window).on("orientationchange resize", a.proxy(this._setPaneDimensions, this)))
			};
		g.DEFAULTS = {
			interval: !1,
			toughness: .25
			...
			return this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$indicators.children().eq(a).addClass("active")), this.$element.trigger("slid.bs.carousel"), this
		};
		var h = a.fn.carousel;
...
// 				}
// 				d = "";
// 				y ? (r && (d += '<div class="user">' + w(f[b].innerHTML) + "</div>"), d += '<p class="tweet">' + w(a[b].innerHTML) + "</p>", q && (d += '<p class="timePosted">' + g[b].getAttribute("aria-label") + "</p>")) : a[b].innerText ? (r && (d += '<p class="user">' + f[b].innerText + "</p>"), d +=
// 					'<p class="tweet">' + a[b].innerText + "</p>", q && (d += '<p class="timePosted">' + g[b].innerText + "</p>")) : (r && (d += '<p class="user">' + f[b].textContent + "</p>"), d += '<p class="tweet">' + a[b].textContent + "</p>", q && (d += '<p class="timePosted">' + g[b].textContent + "</p>"));
...
//
// var kyco = kyco || {};
// kyco.apiPath = "easyshare.php";
// kyco.easyShare = function() {
// 	0 < $("[data-easyshare]").length && $("[data-easyshare]").each(function(a, c) {
// 		var b = $(this),
// 			d = b.data("easyshare-url"),
// 			e = "undefined" === typeof d || "" === d ? window.location.href : d,
// 			f = b.find("[data-easyshare-total-count]"),
// 			g = b.find('[data-easyshare-button-count="facebook"]'),
// 			h = b.find('[data-easyshare-button-count="twitter"]'),
// 			k = b.find('[data-easyshare-button-count="google"]'),
// 			l = b.find("[data-easyshare-loader]");
// 		$.ajax({
// 			url: kyco.apiPath,
// 			type: "GET",
// 			data: {
...
// 			dataType: "json",
// 			success: function(a) {
// 				f.html(kyco.easyShareApproximate(a.Total));
// 				g.html(kyco.easyShareApproximate(a.Facebook));
// 				h.html(kyco.easyShareApproximate(a.Twitter));
// 				k.html(kyco.easyShareApproximate(a.Google));
// 				l.fadeOut(500)
// 			},
// 			error: function() {
// 				f.html(0);
...
// 			}
// 		});
// 		b.find('[data-easyshare-button="facebook"]').click(function() {
// 			var a = ($(window).width() - 500) / 2,
// 				b = ($(window).height() - 400) / 2;
// 			window.open("https://www.facebook.com/sharer/sharer.php?u=" + e, "facebook", "width=500,height=400,top=" + b + ",left=" + a)
// 		});
// 		b.find('[data-easyshare-button="twitter"]').click(function() {
// 			var a = $(this).data("easyshare-tweet-text") || "",
// 				b = ($(window).width() - 575) / 2,
// 				c = ($(window).height() - 440) / 2,
// 				a = "http://twitter.com/share?text=" + encodeURIComponent(a);
// 			window.open(a, "twitter", "status=1,width=575,height=440,top=" + c + ",left=" + b)
// 		});
// 		b.find('[data-easyshare-button="google"]').click(function() {
// 			var a = ($(window).width() - 500) / 2,
// 				b = ($(window).height() - 400) / 2;
// 			window.open("https://plus.google.com/share?url=" + e, "google+", "width=500,height=400,top=" + b + ",left=" + a)
// 		})
// 	})
// };
// kyco.easyShareAddCommas = function(a) {
// 	var c = [],
// 		b = Math.round(a).toString().split("");
// 	if (1E3 > a) return a.toString();
// 	b.reverse().forEach(function(a, b) {
// 		b && 0 === b % 3 && c.push(",");
// 		c.push(a)
// 	});
// 	return c.reverse().join("")
// };
// kyco.easyShareFormatDecimals = function(a, c) {
// 	var b = a / c;
// 	return 10 > b ? Math.round(10 * b) / 10 : Math.round(b)
// };
// kyco.easyShareApproximate = function(a) {
// 	var c = 0 > a;
// 	c && (a = Math.abs(a));
// 	a = 1E4 > a ? kyco.easyShareAddCommas(a) : 1E6 > a ? kyco.easyShareFormatDecimals(a, 1E3) + "k" : 1E9 > a ? kyco.easyShareFormatDecimals(a, 1E6) + "m" : kyco.easyShareAddCommas(kyco.easyShareFormatDecimals(a, 1E9)) + "b";
// 	c && (a = "-" + a);
// 	return a
// };
...
// 				s = this;
// 			if (this.isIE() <= 9) {
// 				t.find("li.active").has("ul").children("ul").collapse("show");
// 				t.find("li").not(".active").has("ul").children("ul").collapse("hide")
// 			} else {
// 				t.find("li.active").has("ul").children("ul").addClass("collapse in");
// 				t.find("li").not(".active").has("ul").children("ul").addClass("collapse")
// 			}
// 			if (s.settings.doubleTapToGo) {
// 				t.find("li.active").has("ul").children("a").addClass("doubleTapToGo")
// 			}
// 			t.find("li").has("ul").children("a").on("click" + "." + i, function(t) {
// 				t.preventDefault();
// 				if (s.settings.doubleTapToGo) {
// 					if (s.doubleTapToGo(e(this)) && e(this).attr("href") !== "#" && e(this).attr("href") !== "") {
// 						t.stopPropagation();
// 						n.location = e(this).attr("href");
// 						return
// 					}
// 				}
...
// 			while (r.innerHTML = "<!--[if gt IE " + ++t + "]><i></i><![endif]-->", i[0]) {
// 				return t > 4 ? t : e
// 			}
// 		},
// 		doubleTapToGo: function(e) {
// 			var t = this.element;
// 			if (e.hasClass("doubleTapToGo")) {
// 				e.removeClass("doubleTapToGo");
// 				return true
// 			}
// 			if (e.parent().children("ul").length) {
// 				t.find(".doubleTapToGo").removeClass("doubleTapToGo");
...
// 								var u = e.attr(void 0 !== e.attr("max") ? "max" : "aria-valuemax");
...
// 								c = "Too low: Minimum of '" + v + "'<!-- data-validation-min-message to override -->", e.data("validationMinMessage") && (c = e.data("validationMinMessage")), e.data("validationMinMessage", c), e.data("validationMinMin", v)
// 							}
...
// 						}
// 						void 0 !== e.data("validation") && (d = e.data("validation").split(",")), a.each(e.data(), function(a) {
...
// 							d[a] = o(e)
// 						}), d = a.unique(d), g = [], a.each(m, function(i, n) {
...
// 								})
// 							}
// 						}), m = g; while (m.length > 0);
// 						var h = {};
// 						a.each(d, function(i, n) {
// 							var r = e.data("validation" + n + "Message"),
// 								s = void 0 !== r,
// 								l = !1;
// 							if (r = r ? r : "'" + n + "' validation failed <!-- Add attribute 'data-validation-" + n.toLowerCase() + "-message' to input to change this message -->", a.each(t.validatorTypes, function(t, i) {
